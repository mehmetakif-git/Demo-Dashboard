    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatsCard
          ...
          icon={Users}
          trend={{ value: selectedEventData ? `of ${selectedEventData.expectedAttendees} expected` : '', type: 'neutral' }}
        />
        <StatsCard
          title="Confirmed"
        ...
        <StatsCard
          ...
          icon={Clock}
          trend={{ value: 'Awaiting confirmation', type: 'neutral' }}
        />
        <StatsCard
          title="Cancelled"
          value={registrationStats.cancelled.toString()}
          icon={XCircle}
          trend={{ value: 'Cancellations', type: registrationStats.cancelled > 0 ? 'down' : 'neutral' }}
        />
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/[0.08]">
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold uppercase text-[#64748b]">Registered</th>
