      ...
      {viewMode === 'cards' ? (
          ...
          {jobPostings.map((job, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 mt-4">
                <button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-[#6366f1]/10 text-[#6366f1] text-sm font-medium hover:bg-[#6366f1]/20 transition-colors cursor-pointer">
        ...
        >
          <table className="w-full">
            ...
            <tbody>
              {jobPostings.map((job) => (
                <tr key={job.id} className="border-t border-[#1e1e2e] hover:bg-[#1a1a24]">
                  ...
                  <td className="px-4 py-4">
                    <span className="px-2 py-1 rounded-full bg-[#6366f1]/10 text-[#6366f1] text-sm font-medium">
                      {job.applicants}
                    </span>
                  </td>
                  <td className="px-4 py-4">
