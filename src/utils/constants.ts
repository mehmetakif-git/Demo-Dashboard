...
export const ROUTES = {
  ...
  realestate: {
    ...
    listings: '/dashboard/realestate/listings',
    leads: '/dashboard/realestate/leads',
    viewings: '/dashboard/realestate/viewings',
    offers: '/dashboard/realestate/offers',
    contracts: '/dashboard/realestate/contracts',
    commissions: '/dashboard/realestate/commissions',
    tenants: '/dashboard/realestate/tenants',
    landlords: '/dashboard/realestate/landlords',
    maintenance: '/dashboard/realestate/maintenance',
    payments: '/dashboard/realestate/payments',
    reports: '/dashboard/realestate/reports',
  },
  agency: {
  ...
  ecommerce: {
    ...
    overview: '/dashboard/ecommerce/overview',
    orders: '/dashboard/ecommerce/orders',
    orderDetail: '/dashboard/ecommerce/orders/:id',
    products: '/dashboard/ecommerce/products',
    productDetail: '/dashboard/ecommerce/products/:id',
    categories: '/dashboard/ecommerce/categories',
    customers: '/dashboard/ecommerce/customers',
    customerDetail: '/dashboard/ecommerce/customers/:id',
    inventory: '/dashboard/ecommerce/inventory',
    discounts: '/dashboard/ecommerce/discounts',
    shipping: '/dashboard/ecommerce/shipping',
    reviews: '/dashboard/ecommerce/reviews',
  },
  restaurant: {
    root: '/dashboard/restaurant',
    ...
    delivery: '/dashboard/restaurant/delivery',
    inventory: '/dashboard/restaurant/inventory',
    staff: '/dashboard/restaurant/staff',
    analytics: '/dashboard/restaurant/analytics',
    qrCodes: '/dashboard/restaurant/qr-codes',
    feedback: '/dashboard/restaurant/feedback',
  },
  healthcare: {
    root: '/dashboard/healthcare',
    patients: '/dashboard/healthcare/patients',
    patientDetail: '/dashboard/healthcare/patients/:id',
    appointments: '/dashboard/healthcare/appointments',
    consultations: '/dashboard/healthcare/consultations',
    prescriptions: '/dashboard/healthcare/prescriptions',
    laboratory: '/dashboard/healthcare/laboratory',
    radiology: '/dashboard/healthcare/radiology',
    pharmacy: '/dashboard/healthcare/pharmacy',
    billing: '/dashboard/healthcare/billing',
    insurance: '/dashboard/healthcare/insurance',
    medicalRecords: '/dashboard/healthcare/medical-records',
    reports: '/dashboard/healthcare/reports',
    bedManagement: '/dashboard/healthcare/bed-management',
  },
  education: {
    root: '/dashboard/education',
    students: '/dashboard/education/students',
    studentDetail: '/dashboard/education/students/:id',
    classes: '/dashboard/education/classes',
    teachers: '/dashboard/education/teachers',
    curriculum: '/dashboard/education/curriculum',
    attendance: '/dashboard/education/attendance',
    exams: '/dashboard/education/exams',
    assignments: '/dashboard/education/assignments',
    grades: '/dashboard/education/grades',
    parents: '/dashboard/education/parents',
    library: '/dashboard/education/library',
    transport: '/dashboard/education/transport',
    fees: '/dashboard/education/fees',
  },
  hotel: {
    root: '/dashboard/hotel',
    rooms: '/dashboard/hotel/rooms',
    roomDetail: '/dashboard/hotel/rooms/:id',
    reservations: '/dashboard/hotel/reservations',
    reservationDetail: '/dashboard/hotel/reservations/:id',
    checkin: '/dashboard/hotel/checkin',
    guests: '/dashboard/hotel/guests',
    guestDetail: '/dashboard/hotel/guests/:id',
    housekeeping: '/dashboard/hotel/housekeeping',
    frontdesk: '/dashboard/hotel/frontdesk',
    roomService: '/dashboard/hotel/room-service',
    maintenance: '/dashboard/hotel/maintenance',
    billing: '/dashboard/hotel/billing',
    packages: '/dashboard/hotel/packages',
  ...
  logistics: {
    root: '/dashboard/logistics',
    fleet: '/dashboard/logistics/fleet',
    vehicleDetail: '/dashboard/logistics/fleet/:id',
    routes: '/dashboard/logistics/routes',
    shipments: '/dashboard/logistics/shipments',
    shipmentDetail: '/dashboard/logistics/shipments/:id',
    warehouse: '/dashboard/logistics/warehouse',
    drivers: '/dashboard/logistics/drivers',
    driverDetail: '/dashboard/logistics/drivers/:id',
    fuel: '/dashboard/logistics/fuel',
    maintenance: '/dashboard/logistics/maintenance',
    tracking: '/dashboard/logistics/tracking',
    invoicing: '/dashboard/logistics/invoicing',
    clients: '/dashboard/logistics/clients',
    clientDetail: '/dashboard/logistics/clients/:id',
    reports: '/dashboard/logistics/reports',
    compliance: '/dashboard/logistics/compliance',
  },
  manufacturing: {
    root: '/dashboard/manufacturing',
    production: '/dashboard/manufacturing/production',
    workOrders: '/dashboard/manufacturing/work-orders',
    bom: '/dashboard/manufacturing/bom',
    inventory: '/dashboard/manufacturing/inventory',
    quality: '/dashboard/manufacturing/quality',
    machines: '/dashboard/manufacturing/machines',
    maintenance: '/dashboard/manufacturing/maintenance',
    planning: '/dashboard/manufacturing/planning',
    finishedGoods: '/dashboard/manufacturing/finished-goods',
    waste: '/dashboard/manufacturing/waste',
    shifts: '/dashboard/manufacturing/shifts',
    reports: '/dashboard/manufacturing/reports',
  },
  law: {
    root: '/dashboard/law',
    cases: '/dashboard/law/cases',
    clients: '/dashboard/law/clients',
    hearings: '/dashboard/law/hearings',
    documents: '/dashboard/law/documents',
    contracts: '/dashboard/law/contracts',
    billing: '/dashboard/law/billing',
    calendar: '/dashboard/law/calendar',
    research: '/dashboard/law/research',
    timeTracking: '/dashboard/law/time-tracking',
    opposing: '/dashboard/law/opposing',
    settlements: '/dashboard/law/settlements',
    reports: '/dashboard/law/reports',
  },
} as const;
