...
export const vehicles: Vehicle[] = [
  { id: "VEH001", plateNo: "34-ABC-123", type: "Truck", make: "Mercedes", model: "Actros 1844", year: 2022, capacity: 18000, unit: "kg", fuelType: "Diesel", status: "active", currentDriver: "DRV001", driverName: "Khalid Rahman", currentLocation: "Doha Warehouse", coordinates: { lat: 25.2867, lng: 51.5333 }, lastMaintenance: "2024-01-10", nextMaintenance: "2024-02-10", mileage: 45200, ownership: "owned", purchaseDate: "2022-06-15", purchaseCost: 320000 },
  { id: "VEH002", plateNo: "34-DEF-456", type: "Van", make: "Ford", model: "Transit", year: 2023, capacity: 3500, unit: "kg", fuelType: "Diesel", status: "on-route", currentDriver: "DRV002", driverName: "Omar Bashar", currentLocation: "En Route - Al Khor", coordinates: { lat: 25.5203, lng: 51.5069 }, lastMaintenance: "2024-01-12", nextMaintenance: "2024-02-12", mileage: 28500, ownership: "leased", purchaseDate: "2023-03-20", purchaseCost: 95000 },
  { id: "VEH003", plateNo: "34-GHI-789", type: "Truck", make: "Volvo", model: "FH16", year: 2021, capacity: 20000, unit: "kg", fuelType: "Diesel", status: "on-route", currentDriver: "DRV003", driverName: "Ravi Patel", currentLocation: "En Route - Industrial Area", coordinates: { lat: 25.2185, lng: 51.4430 }, lastMaintenance: "2024-01-08", nextMaintenance: "2024-02-08", mileage: 62400, ownership: "owned", purchaseDate: "2021-09-10", purchaseCost: 380000 },
  { id: "VEH004", plateNo: "34-JKL-012", type: "Van", make: "Mercedes", model: "Sprinter", year: 2023, capacity: 2500, unit: "kg", fuelType: "Diesel", status: "maintenance", currentDriver: null, driverName: null, currentLocation: "Service Center", coordinates: { lat: 25.2750, lng: 51.5200 }, lastMaintenance: "2024-01-16", nextMaintenance: "2024-02-16", mileage: 18200, ownership: "leased", purchaseDate: "2023-05-15", purchaseCost: 85000 },
  { id: "VEH005", plateNo: "34-MNO-345", type: "Truck", make: "Scania", model: "R450", year: 2022, capacity: 22000, unit: "kg", fuelType: "Diesel", status: "active", currentDriver: "DRV004", driverName: "Yusuf Ibrahim", currentLocation: "Doha Warehouse", coordinates: { lat: 25.2880, lng: 51.5350 }, lastMaintenance: "2024-01-14", nextMaintenance: "2024-02-14", mileage: 51800, ownership: "owned", purchaseDate: "2022-11-05", purchaseCost: 350000 },
  { id: "VEH006", plateNo: "34-PQR-678", type: "Pickup", make: "Toyota", model: "Hilux", year: 2024, capacity: 1000, unit: "kg", fuelType: "Diesel", status: "active", currentDriver: "DRV005", driverName: "Naeem Sheikh", currentLocation: "Office", coordinates: { lat: 25.3200, lng: 51.5310 }, lastMaintenance: "2024-01-05", nextMaintenance: "2024-02-05", mileage: 8500, ownership: "owned", purchaseDate: "2024-01-02", purchaseCost: 125000 }
];

export const drivers: Driver[] = [
  { id: "DRV001", employeeNo: "EMP-D001", name: "Khalid Rahman", licenseNo: "QA-123456789", licenseExpiry: "2026-12-31", phone: "+974 5555 4001", email: "khalid.driver@logistics.qa", address: "West Bay, Doha", dateOfBirth: "1985-03-15", hireDate: "2020-06-01", status: "active", currentVehicle: "VEH001", vehiclePlate: "34-ABC-123", rating: 4.8, totalTrips: 1250, emergencyContact: "Fatima Rahman - +974 5555 4002", medicalCheckup: "2023-11-20", nextMedicalCheckup: "2024-11-20" },
  { id: "DRV002", employeeNo: "EMP-D002", name: "Omar Bashar", licenseNo: "QA-987654321", licenseExpiry: "2027-06-30", phone: "+974 5555 4003", email: "omar.driver@logistics.qa", address: "Al Sadd, Doha", dateOfBirth: "1990-07-22", hireDate: "2021-03-15", status: "active", currentVehicle: "VEH002", vehiclePlate: "34-DEF-456", rating: 4.9, totalTrips: 850, emergencyContact: "Layla Bashar - +974 5555 4004", medicalCheckup: "2023-12-10", nextMedicalCheckup: "2024-12-10" },
  { id: "DRV003", employeeNo: "EMP-D003", name: "Ravi Patel", licenseNo: "QA-456789123", licenseExpiry: "2025-09-30", phone: "+974 5555 4005", email: "ravi.driver@logistics.qa", address: "Industrial Area, Doha", dateOfBirth: "1988-11-08", hireDate: "2019-08-20", status: "active", currentVehicle: "VEH003", vehiclePlate: "34-GHI-789", rating: 4.7, totalTrips: 1580, emergencyContact: "Priya Patel - +974 5555 4006", medicalCheckup: "2023-10-15", nextMedicalCheckup: "2024-10-15" },
  { id: "DRV004", employeeNo: "EMP-D004", name: "Yusuf Ibrahim", licenseNo: "QA-789123456", licenseExpiry: "2026-03-31", phone: "+974 5555 4007", email: "yusuf.driver@logistics.qa", address: "Al Wakrah, Doha", dateOfBirth: "1992-05-30", hireDate: "2022-01-10", status: "active", currentVehicle: "VEH005", vehiclePlate: "34-MNO-345", rating: 4.6, totalTrips: 520, emergencyContact: "Amina Ibrahim - +974 5555 4008", medicalCheckup: "2024-01-05", nextMedicalCheckup: "2025-01-05" },
  { id: "DRV005", employeeNo: "EMP-D005", name: "Naeem Sheikh", licenseNo: "QA-321654987", licenseExpiry: "2027-12-31", phone: "+974 5555 4009", email: "naeem.driver@logistics.qa", address: "Al Rayyan, Doha", dateOfBirth: "1995-09-18", hireDate: "2023-06-01", status: "active", currentVehicle: "VEH006", vehiclePlate: "34-PQR-678", rating: 4.5, totalTrips: 180, emergencyContact: "Sara Sheikh - +974 5555 4010", medicalCheckup: "2023-09-10", nextMedicalCheckup: "2024-09-10" },
  { id: "DRV006", employeeNo: "EMP-D006", name: "Carlos Mendez", licenseNo: "QA-654987321", licenseExpiry: "2025-06-30", phone: "+974 5555 4011", email: "carlos.driver@logistics.qa", address: "Lusail, Doha", dateOfBirth: "1987-12-12", hireDate: "2020-09-15", status: "on-leave", currentVehicle: null, vehiclePlate: null, rating: 4.7, totalTrips: 1120, emergencyContact: "Maria Mendez - +974 5555 4012", medicalCheckup: "2023-08-20", nextMedicalCheckup: "2024-08-20" }
];
